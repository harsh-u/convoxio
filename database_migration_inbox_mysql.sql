-- Database migration for Inbox functionality (MySQL Compatible)
-- Add new Contact table and update MessageHistory table

-- Create Contact table (MySQL syntax)
CREATE TABLE IF NOT EXISTS contact (
    ...
    INDEX idx_contact_last_message (last_message_at DESC)
);

-- Create indexes for message_history (MySQL syntax - without IF NOT EXISTS)
...
-- Create contacts from existing message history (MySQL syntax)
